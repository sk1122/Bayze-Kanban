...
var invite_back = document.getElementById('back')

invite.addEventListener('click', function() {
	invite.style.display = 'none'
	invite_back.style.display = 'block'

	console.log("Clicked")
})

invite_back.addEventListener('keypress', function(e) {
	if(e.keyCode == 13) {
		invite.style.display = 'block'
		invite_back.style.display = 'none'
	}
})
